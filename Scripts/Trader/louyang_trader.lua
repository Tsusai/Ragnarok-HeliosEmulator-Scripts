...
trader("lou_in02","Tool Dealer","4_F_CHNWOMAN",239,176,5,0,0)
OnInit:()
	sellitem Arrow
	sellitem Iron_Arrow
	sellitem Spectacles
...
trader("lou_in02","Armor Dealer","4_F_CHNWOMAN",121,182,5,0,0)
OnInit:()
	sellitem Bandana
	sellitem Sandals
	sellitem Shoes
...
trader("lou_in02","Weapon Dealer","4_M_CHNMAN",130,182,5,0,0)
OnInit:()
