...
function Metheus_Sylphe()
	--Job and level Variable here
		local temp = getvar("valkyrie_q", 1) --Not sure if this is right...
			...
			if mresult == 1 then
				...
				--Still needs goldcheck Code with
				--The decline message when gold isn't enough
			elseif
				dialog "Metheus Sylphe"
