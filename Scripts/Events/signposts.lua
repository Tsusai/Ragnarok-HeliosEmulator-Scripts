...
npc("prontera","Sign Post",SPRITE_HIDDEN_NPC,158,213,1,1,1,"prontera_Sign_Post_158213")
...
npc("prontera","Prontera Bulletin",SPRITE_HIDDEN_NPC,156,197,1,1,1,"prontera_Prontera_Bulletin_156197")
...
npc("prontera","Sign",SPRITE_HIDDEN_NPC,278,212,1,1,1,"prontera_Sign_278212")
...
npc("prontera","Sign",SPRITE_HIDDEN_NPC,150,326,1,1,1,"prontera_Sign_150326")
...
npc("prontera","Billboard",SPRITE_HIDDEN_NPC,31,212,1,1,1,"prontera_Billboard_31212")
...
npc("prontera","Billboard",SPRITE_HIDDEN_NPC,165,305,1,1,1,"prontera_Billboard_165305")
...
npc("prontera","Sign",SPRITE_HIDDEN_NPC,147,305,1,1,1,"prontera_Sign_147305")
...
npc("prontera","Sign",SPRITE_HIDDEN_NPC,145,304,1,1,1,"prontera_Sign_145304")
...
npc("morocc","Sign",SPRITE_HIDDEN_NPC,144,84,1,1,1,"morocc_Sign_14484")
...
npc("morocc","Sign",SPRITE_HIDDEN_NPC,145,83,1,1,1,"morocc_Sign_14583")
...
npc("morocc","Bulletin",SPRITE_HIDDEN_NPC,32,174,1,1,1,"morocc_Bulletin_32174")
...
npc("morocc","Sign",SPRITE_HIDDEN_NPC,168,266,1,1,1,"morocc_Sign_168266")
...
npc("morocc","Billboard",SPRITE_HIDDEN_NPC,168,264,1,1,1,"morocc_Billboard_168264")
...
npc("morocc","Sign",SPRITE_HIDDEN_NPC,298,211,1,1,1,"morocc_Sign_298211")
...
npc("geffen","Geffen Bulletin",SPRITE_HIDDEN_NPC,116,58,1,1,1,"geffen_Geffen_Bulletin_11658")
...
npc("geffen","Sign",SPRITE_HIDDEN_NPC,61,174,1,1,1,"geffen_Sign_61174")
...
npc("geffen","Billboard",SPRITE_HIDDEN_NPC,113,104,1,1,1,"geffen_Billboard_113104")
...
npc("geffen","Sign Post",SPRITE_HIDDEN_NPC,119,190,1,1,1,"geffen_Sign_Post_119190")
...
npc("geffen","Sign",SPRITE_HIDDEN_NPC,168,175,1,1,1,"geffen_Sign_168175")
...
npc("geffen","Sign",SPRITE_HIDDEN_NPC,183,61,1,1,1,"geffen_Sign_18361")
...
npc("aldebaran","Billboard",SPRITE_HIDDEN_NPC,181,172,1,1,1,"aldebaran_Billboard_181172")
...
npc("aldebaran","Al De Baran Bulletin",SPRITE_HIDDEN_NPC,133,104,1,1,1,"aldebaran_Al_De_Baran_Bulletin_133104")
...
npc("aldebaran","Billboard",SPRITE_HIDDEN_NPC,54,223,1,1,1,"aldebaran_Billboard_54223")
...
npc("aldebaran","Sign",SPRITE_HIDDEN_NPC,217,222,1,1,1,"aldebaran_Sign_217222")
...
npc("izlude","Sign",SPRITE_HIDDEN_NPC,54,139,1,1,1,"izlude_Sign_54139")
...
npc("izlude","Sign",SPRITE_HIDDEN_NPC,144,148,1,1,1,"izlude_Sign_144148")
...
npc("alberta","Billboard",SPRITE_HIDDEN_NPC,35,241,1,1,1,"alberta_Billboard_35241")
...
npc("alberta","Billboard",SPRITE_HIDDEN_NPC,37,39,1,1,1,"alberta_Billboard_3739")
...
npc("alberta","Sign",SPRITE_HIDDEN_NPC,99,151,1,1,1,"alberta_Sign_99151")
...
npc("alberta","Sign",SPRITE_HIDDEN_NPC,196,152,1,1,1,"alberta_Sign_196152")
...
npc("alberta","Sign",SPRITE_HIDDEN_NPC,149,54,1,1,1,"alberta_Sign_14954")
